...
def _reset_advanced_settings() -> None:
    ...
    st.session_state.n_results_per_collection = 3
    st.session_state.max_chunks = 8
    st.session_state.reranker_candidate_pool = 24
    st.session_state.min_rerank_score = 0.25
